...
export default function IntroAnimation() {
  ...
  useEffect(() => {
    ...
    const handleWheel = (e: WheelEvent) => {
      ...
      // ✅ Release scroll to page when hero animation is done
      if (atBottom || atTop) return;

      // Otherwise hijack it for the internal virtual scroll
      e.preventDefault();
    ...
    >
      ...
      <div className="flex h-full w-full flex-col items-center justify-center perspective-1000">
        ...
        <div className="absolute z-0 flex flex-col items-center justify-center text-center pointer-events-none top-1/2 -translate-y-1/2">
          ...
          >
            Your mind deserves gentle support
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={
          ...
          >
            AI-powered · Always available · Always private
          </motion.p>
        </div>
        ...
        >
          ...
          <p className="text-sm md:text-base text-gray-600 max-w-lg leading-relaxed">
            Serene is an AI mental health companion trained to listen, guide,
            and support you through anxiety, stress, and low mood — using
            evidence-based techniques, 24/7.
          </p>
        </motion.div>
